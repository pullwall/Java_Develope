...
public class CreateRoomDisplay extends JDialog implements ActionListener, ItemListener {
    ...
    public CreateRoomDisplay(JFrame frame, ClientThread client){
        super(frame,true);      // modal은 주변을 어둡게 하여 창을 집중시키게 하는 효과
        ...
        group.add(radio1);
        radio2 = new JRadioButton("3 명");
        radio2.addItemListener(this);
        group.add(radio2);
        radio3 = new JRadioButton("4 명");
        radio3.addItemListener(this);
        group.add(radio3);
        radio4 = new JRadioButton("5 명");
        ...
        radioPanel.add(rock);
        radioPanel.setBounds(10, 130, 280, 20); c.add (radioPanel);
        ...
        setSize (300, 300);
        setLocation(dim.width/2-getWidth()/2,dim.height/2-getWidth()/2);
        setResizable(false);
        setVisible(true);
